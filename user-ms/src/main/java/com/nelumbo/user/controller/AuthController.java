...
public class AuthController {
    ...
    public ResponseEntity<LoginResponseDto> authenticate(@RequestBody @Valid LoginUserDto loginUserDto) throws BadRequestException {
    ...
    public ResponseEntity<String> verifyUser(@RequestBody @Valid VerifyUserDto verifyUserDto) throws BadRequestException {
    ...
    public ResponseEntity<String> resendVerificationCode(@RequestParam String email) throws BadRequestException {
    ...
    public ResponseEntity<UserDto> validateToken(@RequestHeader("Authorization") String token) throws BadRequestException {
